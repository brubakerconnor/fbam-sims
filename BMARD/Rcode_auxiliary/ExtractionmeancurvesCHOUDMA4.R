...
# capture the value of an argument in the Rscript sentence in bash, used in a for loop on bash
X<-as.numeric(  commandArgs()[6])

# change the directory accordingly
dbase<-readRDS( paste("~/BMARD_code/Rcode/ChoudhuriMA4_V",X,".rds", sep="")   )
...
# change the directory accordingly
saveRDS(T_T,paste( "~/BMARD_code/Rcode/meancurvechoudMA4_",X,".rds",sep=""  ) )
